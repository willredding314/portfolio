        ...
        <section>
            <Container fluid className="code-container">
                ...
                <Container fluid className="code-section">
                    <h1 className="white">My Projects</h1>
                    <Container className="projects">
                        <Row>
                            <Col md="5">
                                <img src={logo} width="200" height="200"/>
                                <h2 className="white">This Site!</h2>
                                <h6 className="white">
                                ...
                                <a href="" ><AiFillGithub className="gh-link" size="40"/></a>
                            </Col>
                            <Col md="2"></Col>
                            <Col md="5">
                                <img src={d20} width="200" height="200"/>
                                <h2 className="white">5e Playtest Arena</h2>
                                <h6 className="white">
                        ...
                        <Row>
                            <Col md="5">
                                <BiCameraMovie size="200" color="white"/>
                                <h2 className="white">Movie Recs</h2>
                                <h6 className="white">
                                ...
                                <a href="https://github.com/willredding314/OasisProject" ><AiFillGithub className="gh-link" size="40"/></a>
                            </Col>
                            <Col md="2"></Col>
                            <Col md="5">
                                <AiOutlineFileImage size="200" color="white" />
                                <h2 className="white">Vido Image Processing</h2>
                                <h6 className="white">
                                ...
                                <a href="https://github.com/willredding314/VidoImageProcessing" ><AiFillGithub className="gh-link" size="40"/></a>
                            </Col>
                        </Row>
                    </Container>
                    <br></br>
